        ...
        {!s0.nameChoosen ? (
          ...
          <>
            ...
            {!s0.shipAlreadyInFleet ? (
              <>
                {ShipSelector({
                  onChange: (e) => setState((s0) => HandleShipChange(e)(s0)),
                ...
                {ButtonWidget({
                  ...
                  hidden: s0.selectedShip === undefined || s0.data.value === 0,
                })}
                {ButtonWidget({
                ...
                {SummaryWidget({ shipList: s0.fleet })}
              </>
            ) : (
              <>
                {ShipSelector({
                  ...
                  oldAmountOfShips: s0.fleet.find(
                    (s) =>
                      (s.ship as Ship).name === (s0.selectedShip as Ship).name
                  )?.amount,
                })}
                {ButtonWidget({
                  key: "increment",
